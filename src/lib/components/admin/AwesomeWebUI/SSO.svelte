		...
		{#if adminConfig}
			<div class="space-y-4">
				...
				>
						<summary class="cursor-pointer text-base font-medium">
							<span class="inline-flex items-center gap-2">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="size-5" aria-hidden="true">
									<path
										fill="#EA4335"
					...
					>
						<summary class="cursor-pointer text-base font-medium">
							<span class="inline-flex items-center gap-2">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" class="size-5" aria-hidden="true">
				...
				>
						<summary class="cursor-pointer text-base font-medium">
							<span class="inline-flex items-center gap-2">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 199" class="size-5" aria-hidden="true">
									<path
										fill="currentColor"
